...
def main(input_file_name, raster_file_name):
    ...
    f_to_tiff.convert_numpy_to_raster(f_to_tiff.csv_to_numpy(final_file_name), raster_file_name)
...
if __name__ == "__main__":
    ...
    main(args.input_file_name, args.raster_file_name)
